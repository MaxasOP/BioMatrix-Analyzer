    ...
    <main className="mx-auto max-w-5xl px-6 py-12">
      <section className="grid gap-6 rounded-[32px] border border-white/10 bg-white/5 p-8 shadow-[0_18px_60px_rgba(0,0,0,0.12)] backdrop-blur-xl">
        ...
        <div className="grid gap-3 sm:grid-cols-[1fr_1fr_auto]">
          ...
          <button
            type="button"
            className="self-end rounded-full bg-cyan-500 px-6 py-3 text-sm font-semibold text-slate-950 transition hover:bg-cyan-400"
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link href="/" className="rounded-full border border-white/10 bg-white/5 px-5 py-3 text-sm font-semibold text-slate-100 transition hover:bg-white/10">
            Back to overview
          </Link>
        </div>
      </section>
